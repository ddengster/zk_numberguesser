...
contract("Verifier", (accounts)=> {
  ...
  it("VerifierTrueTest", async () => {
    ...
    // compute_proof.bat initiate_game 3 8317554905031743436470060412079836410388093405773061122028896578523632029169 1 5
    let proof = {
      "proof": {
        "a": [
  ...
  it("VerifierTrueTest2", async () => {
    ...
    // Using proof.json generated by
    // compute_proof.bat initiate_game 5 14883451070860890180283647447591394114646513402818392007925225473728118499724 1 7
    let proof = {
      "proof": {
        "a": [
  ...
  it("VerifierWrongEvalTest", async () => {
    ...
    // Using proof.json generated by
    // compute_proof.bat initiate_game 5 1 1 7
